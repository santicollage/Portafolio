  ...
  return (
    <section className='about'>
      ...
      <p className='about__text'>
        <img className='image1' src={image1} alt="Cultivo de flores" />
        ...
        <img className='image2' src={image2} alt="Distrito de riego" />
        ...
        <img className='image3' src={image3} alt="Cultivo de cannbis" />
        ...
        <img className='image4' src={image4} alt="Invernadero de tomate" />
      </p>
    </section>
  );
}
